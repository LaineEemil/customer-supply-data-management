...
echo "<title> Muodosta hinta-arvio kohteelle </title>";
echo "</head>";
echo "<body>";
echo "<form action=hinta_arvio_yhteenveto.php method=POST>";
echo "<fieldset>";
...
$rivi = $kysely->fetch();
    ...
    if (!empty($rivi)) {
        ...
        echo "</fieldset> <br>";
        echo "<input type=submit id=nappi value=".'"'."Avaa hinta-arvio".'"'.">";
        echo "</form>";
