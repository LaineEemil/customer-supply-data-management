...
require 'yhteys.php';
    ...
    echo "<h1> Valitse kohde, jolle luodaan urakkalasku </h1>";
    if (!empty($rivi)) {
        while($rivi) {
            ...
            echo "<li>";
            echo "<form action=urakkatarjous_data.php?asiakas=$_GET[asiakas]&tyokohde=$rivi[kohdetunnus] method=post>". " Kohteen osoite: " . 
